...
import { FuseNavigationService, FuseVerticalNavigationComponent, FuseVerticalNavigationMode } from '@fuse/components/navigation';
...
export class DenseLayoutComponent implements OnInit, OnDestroy
{
    ...
    opened: FuseVerticalNavigationComponent
